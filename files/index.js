...
const UUID = process.env.UUID || 'fb6ae1e7-b14e-4d39-98bc-7663b414f4ba'; //若需要改UUID，需要在config.json里改为一致
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'nzv1.aca.qzz.io';     
const NEZHA_PORT = process.env.NEZHA_PORT || '';                     // 哪吒端口为{443,8443,2096,2087,2083,2053}其中之一开启tls
const NEZHA_KEY = process.env.NEZHA_KEY || 'jaYUkkloL3zcm0Z3ucxCRrPQaKS5iUmg';   // 没用哪吒，把这个参数空着
